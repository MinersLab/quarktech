...
dependencies {
    ...
    implementation("thedarkcolour:kotlinforforge:${property("loader_version")}")
    implementation(fg.deobf("curse.maven:gregtechceu-modern-890405:5753724"))
    implementation(fg.deobf("curse.maven:ldlib-626676:5775541"))
    implementation("com.tterrag.registrate:Registrate:MC1.20-1.3.11")
}
